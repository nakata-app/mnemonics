"""Retrieve memories — embed query, search, apply tier-aware decay scoring."""
...
def retrieve(
    ...
    """Search the store for query. Tier-aware decay is applied unless decay=False."""
    ...
    for r in results:
        ...
        if decay:
            ...
            r["score"] = round(r["raw_score"] * df, 4)
        else:
            r["age_days"] = round(age, 1)
            r["decay_factor"] = 1.0
